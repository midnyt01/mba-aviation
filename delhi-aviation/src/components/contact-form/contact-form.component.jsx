    ...
    <div className="container m-auto grey-section-bg">
      <div className="container-fluid m-auto">
        ...
        <div className="contact-image-wrapper d-flex jc-center fd-col al-item-cen" >
            ...
            <img src={ContactImgBanner} alt="ILAM- Jagannath University, New Delhi" />
          </div>
          <Fade bottom cascade>
          <div className="contact-form-wrapper">
            <form className="contact-form">
              ...
              <div style={{display: 'flex', justifyContent: 'center'}}>
                <button onClick={handleOnClickContact} className="light-text default-cta h-70px" style={{padding: '10px 70px', margin: 'auto'}}>Download Brochure</button>
              </div>
            </form>
          </div>
          </Fade>
